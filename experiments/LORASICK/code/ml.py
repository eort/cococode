...
if inputGUI.OK == False:
    ...
    core.quit()
while input_dict['sess_id'] not in list(range(1,param['n_blocks']+1))+['scr','prac']:
...
perms = list(it.permutations(range(param['n_sess'])))
if trial_info['sess_id'] not in range(1,param['n_sess']+1):
    color_idx = 0
else:
    color_idx=perms[trial_info['sub_id']%len(perms)][trial_info['sess_id']-1]
