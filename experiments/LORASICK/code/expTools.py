...
def fancyFixDot(window,bg_color,fg_color='white',size=0.4):
    ...
    rect_horiz = visual.Rect(win=window,pos=[-shift, 0] , width=size,height=size/6,fillColor=bg_color,lineColor=bg_color,autoLog=0)
    rect_vert = visual.Rect(win=window,pos=[-shift, 0], width=size/6,height=size,fillColor=bg_color,lineColor=bg_color,autoLog=0)
